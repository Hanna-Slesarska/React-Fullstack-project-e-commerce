  ...
  export const aboutData = [
    {
      ...
      img: "about1",
      title: "Our Journey",
      desc: "Driven by a love for fashion and a desire to create a space where every woman feels seen and celebrated, Sophie was born. From humble beginnings, our journey has been about more than just clothing; it's about fostering a community where women can express themselves freely and confidently through fashion."
    },
    {
      id: 2,
      img: "about2",
      title: "Our Mission",
      desc: "Our mission is simple: to provide women with stylish, high-quality clothing that not only looks good but also makes them feel amazing. We're committed to offering a diverse range of pieces that cater to different tastes, body types, and occasions, ensuring that every woman can find something that speaks to her unique style."
    },
    {
      id: 3,
      img: "about3",
      title: "What Sets Us Apart",
      desc: "We believe in building meaningful connections with our customers, understanding their needs, and providing personalized service that exceeds expectations. Whether you're looking for the perfect outfit for a special occasion or simply updating your wardrobe staples, our dedicated team is here to help you every step of the way."
    }
  ];
